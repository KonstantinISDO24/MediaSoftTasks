...
public class MatchController {
    ...
    @PostMapping
    public ResponseEntity<Void> registerMatch(
    ...
    public ResponseEntity<Map<String, Integer>> getStandings(
        ...
        Map<String, Integer> standings = matchService.getStandings(season, date);
